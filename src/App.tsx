...
const INITIAL_SITE_SETTINGS: import('./types').SiteSettings = {
  storeName: 'دكان الملكي الفاخر',
  heroBadge: '✨ دُكان الشرق البلاتيني - الفخامة العالمية',
  heroTitle: 'مجموعة استثنائية من السلع الفاخرة المعتمدة دولياً',
  aboutUs: 'متجر دكّان الشَّرق هو متجر ريادي استثنائي تأسس ليعيد صياغة مفهوم التسوّق الفاخر والأصيل في اليمن والشرق الأوسط. نحن نجمع بكل فخر وعناية بين الأصالة العتيقة للمنتجات الشرقية والابتكار العصري؛ لنوفر لنخبة عملائنا الكرام أرقى العطور النادرة، حبوب القهوة المختصة ذات الجودة البلاتينية، والإلكترونيات الاستثنائية بلمسة ساحرة تلبي شغفك وتجعل من تسوقك تجربة ملكية لا تنسى.',
  heroSubtitle: 'نحن نوفر لعملائنا في جميع قارات العالم أرقى العطور الشرقية المقطرة، مستلزمات القهوة المختصة العريقة، وأرقى الابتكارات الإلكترونية الحديثة المدعومة بشبكة لوجستية عالمية سريعة.',
  contactDescription: 'يسعدنا في "دكّان الشَّرق" تلقي استفساراتكم الاستثنائية بخصوص صياغة الهدايا الفخمة، أو تلبية الطلبات للمحافظات اليمنية والخليجية. تواصل مباشر بضغطة واحدة مع مالك المتجر والمدير العام عبر قنوات الواتساب والمحادثة المؤمنة لمصاحبة مسار مشترياتكم.',
